...
String display_message(char* input_macro_message)
{
    ...
    case problem:
        ...
        case uitily:
            ...
            case gas_problem:
                ...
                Serial.print(String(property_num,DEC)+"pg");
                Serial.print(",");
                break;
                /*---------------------------------------------*/
            case gas_problem_cleared:
                message_to_display += " Gas Leakage Cleared";
                Serial.print(String(property_num,DEC)+"ng");
                Serial.print(",");
                break;
                /***********************************************/
                /*       sewage case       */
            ...
            case sewage_problem:
                ...
                Serial.print(String(property_num,DEC)+"pu");
                Serial.print(",");
                break;
                /*---------------------------------------------*/
            case sewage_problem_cleared:
                ...
                Serial.print(String(property_num,DEC)+"nu");
                Serial.print(",");
                break;
                /***********************************************/
                /*       water flow case       */
            ...
            message_to_display += "irrational water consumption";
            /* in case that the i2c requests just irrational water flow */
            //macro for processing
            //Serial.print(String(property_num,DEC)+"");
            Serial.print(",");
                break;
            }
            break;
        case security:
            ...
            case Access_granted_Owner:
                ...
                Serial.print(String(property_num,DEC)+"oe");
                Serial.print(",");
                break;
            case wrong_access_trail_owner:
                message_to_display += " Wrong Access trial by Owner";
                Serial.print(String(property_num,DEC)+"po");
                Serial.print(",");
                break;
            case Owner_left:
                message_to_display += " Owner left";
                Serial.print(String(property_num,DEC)+"ol");
                Serial.print(",");
                break;
                /****************************************/
                 /*       guard case       */
            ...
            case Access_granted_guard:
                ...
                Serial.print(String(property_num,DEC)+"se");
                Serial.print(",");
                break;
            case guard_left:
                message_to_display += " Guard left";
                Serial.print(String(property_num,DEC)+"sl");
                Serial.print(",");
                break;
                /****************************************/
                /*       guest case       */
            ...
            case Break_in_Detected:
                ...
                Serial.print(String(property_num,DEC)+"pb");
                Serial.print(",");
                break;
            case Break_in_secured:
                message_to_display += " Break-in Secured";
                Serial.print(String(property_num,DEC)+"nb");
                Serial.print(",");
                break;
                /****************************************/
            }
    ...
    message_to_display += "," + time_format(hour, min);
...
{
    String time= hours_display(hour) + " : " + char_display(minutes);
   /*
   std::string time;
